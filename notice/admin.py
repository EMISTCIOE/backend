...
class NoticeAdmin(admin.ModelAdmin):
    list_display = ('title',  'notice_category', 'is_featured', 'published_date', 'is_active')
    list_filter = ('title', 'description', 'notice_category', 'department_id', 'is_featured', 'published_date', 'is_active')
    search_fields = ('title', 'description', 'notice_category', 'department_id', 'is_featured', 'published_date', 'is_active')
