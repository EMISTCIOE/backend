...
def format(data):
    volume = (
        selectLatest(data)["issue_identification"]["volume"]
        if "volume" in selectLatest(data)["issue_identification"]
        else ""
    )
    number = (
        selectLatest(data)["issue_identification"]["number"]
        if "number" in selectLatest(data)["issue_identification"]
        else ""
    )
