...
GLOBAL_GALLERY_IMAGE_CREATED_SUCCESS = _("Gallery image uploaded successfully.")
GLOBAL_GALLERY_IMAGE_UPDATED_SUCCESS = _("Gallery image updated successfully.")
GLOBAL_GALLERY_IMAGE_DELETED_SUCCESS = _("Gallery image deleted successfully.")
