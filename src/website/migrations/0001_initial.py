        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "event_date",
                    models.DateField(
                        help_text="Date the event took place.",
                        null=True,
                        verbose_name="Date",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the union, e.g. Free Student Union",
                        max_length=100,
                        verbose_name="Union Name",
                    ),
                ),
                (
                    "description",
                    ckeditor.fields.RichTextField(
                        blank=True,
                        help_text="Details or objectives of the union.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the student club, e.g. AMESIN, Tensor, etc.",
                        max_length=100,
                        unique=True,
                ...
                (
                    ...
                    ckeditor.fields.RichTextField(
                        blank=True,
                        help_text="In-depth overview about the club's mission, activities, and history.",
                        verbose_name="Detailed Description",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    ckeditor.fields.RichTextField(
                        blank=True,
                        help_text="Details about the event, purpose, and activities.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "designation",
                    models.CharField(
                        help_text="Position or role, e.g. President, Vice-President, Coordinator.",
                        max_length=100,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Optional caption describing the image.",
                        max_length=255,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "full_name",
                    models.CharField(
                        help_text="Full name of the union member.",
                        max_length=100,
                        verbose_name="Full Name",
                    ),
                ),
                (
                    "designation",
                    models.CharField(
                        help_text="Member's role or title, e.g. President, Secretary, Treasurer.",
                        max_length=100,
                        verbose_name="Designation",
                    ),
                ),
                ...
                (
                    "union",
                    models.ForeignKey(
                        help_text="Union to which this member belongs.",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="members",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "published_date",
                    models.DateField(
                        help_text="Date the report was officially published.",
                        null=True,
                ...
                (
                    "file",
                    models.FileField(
                        help_text="Upload the report file.",
                        null=True,
                ...
                (
                    "fiscal_session",
                    models.ForeignKey(
                        help_text="Select the fiscal session for this report.",
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="campus_reports",
                        to="core.fiscalsessionbs",
                        verbose_name="Fiscal Session",
                    ),
                ),
                (
                    "updated_by",
            ...
            fields=[
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                ...
                                "Assist Campus Chief Academic",
                            ),
                            (
                                "ASSIST_CAMPUS_CHIEF_PLANNING",
                                "Assist Campus Chief Planning",
                            ),
                        ...
                        help_text="Role or position, e.g., Head of Department.",
                        max_length=100,
                        verbose_name="Designation",
                    ),
                ),
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to="website/key-officials",
                        verbose_name="Photo",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Physical address or location of the campus.",
                        max_length=300,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "roll_number",
                    models.CharField(
                        blank=True, max_length=30, verbose_name="Roll Number"
                    ),
                ),
                (
                    "email",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        upload_to="campus/events/gallery/", verbose_name="Image"
                    ),
                ),
                (
                    "caption",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        help_text="Upload the academic calendar file.",
                        null=True,
                        upload_to="website/calenders",
                        verbose_name="File",
                    ),
                ),
                (
