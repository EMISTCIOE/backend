...
from .models import Research, ResearchParticipant, ResearchPublication, ResearchCategory, ResearchCategoryAssignment
...
class ResearchAdmin(admin.ModelAdmin):
    ...
    inlines = [ResearchParticipantInline, ResearchPublicationInline, ResearchCategoryAssignmentInline]
