...
from .serializers import (
    ...
    ProjectCreateUpdateSerializer, ProjectTagSerializer
)
...
class ProjectViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = ['status', 'project_type', 'department', 'is_featured', 'is_published']
    search_fields = ['title', 'description', 'abstract', 'supervisor_name', 'technologies_used']
    ...
    def by_department(self, request):
        ...
        if department_id:
            projects = self.get_queryset().filter(department_id=department_id, is_published=True)
