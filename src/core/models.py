...
class DashboardStats(models.Model):
    ...
    new_users_this_month = models.IntegerField(
        default=0,
        help_text=_("New users registered this month"),
    )
    users_by_role = models.JSONField(
        default=dict,
        blank=True,
        help_text=_("User count grouped by role"),
    )

    # Department Statistics
    total_departments = models.IntegerField(
        default=0,
        help_text=_("Total number of departments"),
    )
    active_departments = models.IntegerField(
        default=0,
        help_text=_("Active departments"),
    )

    # Notice Statistics
    total_notices = models.IntegerField(
        default=0,
        help_text=_("Total number of notices"),
    )
    ...
    notices_by_category = models.JSONField(
        default=dict,
        blank=True,
        help_text=_("Notice count by category"),
    )
    recent_notices_count = models.IntegerField(
        default=0,
        help_text=_("Notices published in last 7 days"),
    )

    # Project Statistics
    total_projects = models.IntegerField(
        default=0,
        help_text=_("Total number of projects"),
    )
    projects_by_status = models.JSONField(
        default=dict,
        blank=True,
        help_text=_("Projects grouped by status"),
    )
    projects_by_type = models.JSONField(
        default=dict,
        blank=True,
        help_text=_("Projects grouped by type"),
    )
    projects_by_department = models.JSONField(
        default=dict,
        blank=True,
        help_text=_("Projects per department"),
    )
    completed_projects_this_year = models.IntegerField(
        default=0,
        help_text=_("Projects completed this year"),
    )

    # Research Statistics
    total_research = models.IntegerField(
        default=0,
        help_text=_("Total research papers"),
    )
    research_by_status = models.JSONField(
        default=dict,
        blank=True,
        help_text=_("Research grouped by status"),
    )
    research_by_type = models.JSONField(
        default=dict,
        blank=True,
        help_text=_("Research grouped by type"),
    )
    published_research_this_year = models.IntegerField(
        default=0,
        help_text=_("Research published this year"),
    )

    # Journal Statistics
    total_articles = models.IntegerField(
        default=0,
        help_text=_("Total journal articles"),
    )
    total_authors = models.IntegerField(default=0, help_text=_("Total authors"))
    total_board_members = models.IntegerField(
        default=0,
        help_text=_("Total board members"),
    )
    ...
    total_suggestions = models.IntegerField(
        default=0,
        help_text=_("Total suggestions received"),
    )

    # Feedback Statistics
    total_feedback_submissions = models.IntegerField(
        default=0,
        help_text=_("Total feedback submissions"),
    )
    pending_feedback = models.IntegerField(default=0, help_text=_("Pending feedback"))

    # Pending/Action Items Statistics
    pending_notices = models.IntegerField(
        default=0,
        help_text=_("Draft notices pending publication"),
    )
    pending_research = models.IntegerField(
        default=0,
        help_text=_("Research papers pending review/publication"),
    )
    pending_events = models.IntegerField(
        default=0,
        help_text=_("Upcoming events not yet started"),
    )
    pending_projects = models.IntegerField(
        default=0,
        help_text=_("Ongoing/incomplete projects"),
    )
