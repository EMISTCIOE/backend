    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_full', models.CharField(help_text='E.g. 2079/2080', max_length=9, unique=True, verbose_name='Full Session')),
                ('session_short', models.CharField(help_text='E.g. 079/80', max_length=5, unique=True, verbose_name='Short Session')),
            ],
            options={
