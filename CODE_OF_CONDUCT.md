...
1. Follow the project's **style guide** for coding standards (e.g., Ruff).
2. Write **clear, modular, and reusable components** with proper documentation.
3. Include meaningful commit messages:

   - Example: `Added api for homepage department section`
...
- Use the project's communication channels (e.g., Discord, GitHub Discussions) for questions or updates.
